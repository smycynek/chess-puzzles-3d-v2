...
export const puzzleData: unknown[] = [
  {
  ...
  },
  {
    ...
    answer: rot13(
      "If white is to move, the black king will not catch up to the white pawn before it promotes.  If black is to move, it can catch up (rule of squares).  It's possible white could still win if black is to move, but it's highly unlikely.",
    ),
  ...
  },
  {
    ...
    answer: rot13('Bc3+ -- skewers the black king and allows for a queen capture.'),
  ...
  },
  {
    ...
    answer: rot13(
      'Bg5+. This draws the king away from the black rook, allowing the white rook to capture it safely.',
    ),
  ...
  },
  {
    ...
    answer: rot13('Nxf2+..Kg1,Ne2#, OR Nxf2+..Kg1, hRg5#'),
  ...
  },
  {
    ...
    answer: rot13('No!  Black can immediately capture.  Try Nb6# instead.'),
  ...
  },
  {
    ...
    answer: rot13('No -- the black rook pins the white rook.'),
  ...
  {
    question:
      'White to move: Can white mate? How? (This one is not mine.  It is from *Bobby Fischer Teaches Chess*).',
    answer: rot13('Yes. (Qxg7...Rxg7,Rb8+...Rg8, g7#)'),
  ...
  },
  {
    ...
    answer: rot13(
      'No.  It is a draw, although if black could convince white into resigning, there could be a possible win.',
    ),
  },
];
